---
title: Announcing the Release of noaaoceans on CRAN
author: Sean
date: '2019-02-15'
categories:
  - R
...
One consequence of finding the hourly average is that we have hidden any geographic effects.  There might be temperature differences at each station. A map with each station and the average temperature at that station will help study this. We will need to combine the water temperature data with the station meta data to accomplish this task. 
```{r prepare_map_data}
...
Building my first R package has been a fun and a good learning experience.  I plan to continuing to develop the package. Please feel free to open an issue on [GitHub](https://www.github.com/warlicks/noaaoceans/issues) if you find any bugs or would like to request a feature.  
