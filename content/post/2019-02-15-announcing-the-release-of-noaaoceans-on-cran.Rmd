...
Building my first R package has been a fun and a good learning experience.  I plan to continuing to develop the package. Please feel free to open an issue on [GitHub](https://github.com/warlicks/noaaoceans/issues/) if you find any bugs or would like to request a feature.  
